...
SUBROUTINE SrvD_InputSolve( p_FAST, m_FAST, u_SrvD, y_ED, y_IfW, y_OpFM, y_BD, y_SD, y_AD, MeshMapData, ErrStat, ErrMsg )
!..................................................................................................................................
   ...
   ELSEIF ( p_FAST%CompInflow == Module_OpFM )  THEN 
      ...
      u_SrvD%LidSpeed = 0
      u_SrvD%MsrPositionsX = 0
      u_SrvD%MsrPositionsY = 0
      u_SrvD%MsrPositionsz = 0
...
SUBROUTINE CalcOutputs_And_SolveForInputs( n_t_global, this_time, this_state, calcJacobian, NextJacCalcTime, &
   ...
   IF ( p_FAST%CompServo == Module_SrvD  ) THEN         
      CALL SrvD_InputSolve( p_FAST, m_FAST, SrvD%Input(1), ED%y, IfW%y, OpFM%y, BD%y, SD%y, AD%y, MeshmapData, ErrStat2, ErrMsg2 )
      CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )  
   END IF         
